...
func TestParseRef(t *testing.T) {
	...
	var testCases = map[string]expectation{
		...
		"registry.hub.docker.com/ivanilves/lstags": {"registry.hub.docker.com", true, "registry.hub.docker.com/ivanilves/lstags", "ivanilves/lstags", "ivanilves/lstags", []string{}, ".*", "https://", false, true},
		"docker.io/ivanilves/lstags":               {"registry.hub.docker.com", true, "registry.hub.docker.com/ivanilves/lstags", "ivanilves/lstags", "ivanilves/lstags", []string{}, ".*", "https://", false, true},
